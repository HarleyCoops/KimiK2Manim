...
tree_file = Path(__file__).parent / "output/Minimal_Surfaces__Mathematical_Soap_Films_in_3D_Space_prerequisite_tree.json"
...
print("="*70)
print("Pipeline API Call Estimation")
print("="*70)
...
print("="*70)
print(f"\nIf you're on step 76, you're approximately {76/total_calls*100:.1f}% complete")
print("="*70)
